...
const deliveryPersonSchema = new mongoose.Schema(
  {
    ...
    deliveryPersonId: { type: Number, unique: true },
    isEmailVerified: { type: Boolean, default: false },
    isActive: { type: Boolean, default: false },
    token: { type: String },
    role: { type: [String], enum: ["admin", "delivery person", "customer", "private seller", "restaurant"], default: ["delivery person"], },
...
deliveryPersonSchema.methods.generateAuthToken = function () {
  return jwt.sign(
    { id: this._id, deliveryPersonId: this.deliveryPersonId, role: this.role },
